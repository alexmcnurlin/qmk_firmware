...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  */
  [BASE] = LAYOUT_ergodox_pretty(
    KC_TILD, KC_1,     KC_2,     KC_3,    KC_4,    KC_5,     __UND__,             __UND__, KC_6,         KC_7,    KC_8,       KC_9,    KC_0,    KC_BSPC,
  ...
  */
  [FUNC] = LAYOUT_ergodox_pretty(
    ...
    _______, _______, _______, LCTL(KC_RGHT), _______,       _______,       _______,          _______, _______, _______, KC_HOME, _______,  KC_MPLY, _______,
    _______, KC_END,  _______, KC_LBRC,       KC_RBRC,       _______,                                  KC_LEFT, KC_DOWN,   KC_UP, KC_RIGHT, _______, _______,
